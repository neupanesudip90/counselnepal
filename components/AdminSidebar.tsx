    ...
    <aside className="w-60 bg-dark min-h-screen flex flex-col fixed left-0 top-0 z-40">
      ...
      <div className="p-5 border-b border-white/10">
        ...
        <div className="mt-3 px-2 py-1 bg-primary/20 rounded-md inline-flex items-center gap-1">
          ...
          <span className="text-cyan text-xs font-medium">Admin Panel</span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-slate text-xs">Super Admin</p>
          </div>
        </div>
        <button className="flex items-center gap-2 text-slate hover:text-white text-xs transition-colors w-full">
